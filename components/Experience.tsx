...
export default function Experience() {
  return (
    <section id="experience" className="py-24 px-6 bg-[#080c18]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-0 md:left-6 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500/50 via-purple-500/30 to-transparent" />
          ...
          <div className="space-y-10">
            {experiences.map((exp, i) => (
              <div key={i} className="relative pl-8 md:pl-20">
                ...
                <div className="rounded-xl border border-[#1e2d4a] bg-[#0f1629] p-6 hover:border-blue-500/40 transition-colors duration-300">
